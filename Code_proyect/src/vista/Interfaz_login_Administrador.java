 ...
 * @author juanjos
 */
public class Interfaz_login_Administrador extends javax.swing.JFrame {

    /**
     * Creates new form Interfaz_Administrador
     */
    public Interfaz_login_Administrador() {
        initComponents();
...
//    public static String texto1 = "";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
//        idAdministrador = Integer.parseInt(jTextField3.getText());

        String Contraseña = "Supremo1234";
        String Correo = "Supremo@gmail.com";
        
        // Condicional del ingreso del admin //

        if (Contraseña.equals(jTextField3.getText()) && Correo.equals(jTextField2.getText())) {

            Interfaz_start_administrador Inad = new Interfaz_start_administrador();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Interfaz_login_Administrador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Interfaz_login_Administrador().setVisible(true);
            }
        });
    }
