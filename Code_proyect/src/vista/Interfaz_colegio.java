 ...
 * @author juanjos
 */
public class Interfaz_colegio extends javax.swing.JFrame {

    /**
     * Creates new form Interfaz_school
     */
    public Interfaz_colegio() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Nombre Colegio* :");
        ...
        jLabel6.setText("DireccionColegio* :");
        ...
        jLabel10.setFont(new java.awt.Font("Playfair Display SC", 0, 18)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/logo.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String telefono2 = jTextField4.getText();
        String correo = jTextField3.getText();
        String dirColegio = jTextField5.getText();
        String comuna = jTextField6.getText();
        String codigoBarrio = jTextField7.getText();
        String nomBarrio = jTextField8.getText();

        if (!nomColegio.equals("") && !telefono.equals("") && !correo.equals("") && !dirColegio.equals("") && !comuna.equals("") && !codigoBarrio.equals("") && !codigoBarrio.equals("")) {
            if (!telefono2.equals("")) {
                Colegio objc = new Colegio(nomColegio, telefono, telefono2, correo, dirColegio, comuna, codigoBarrio, nomBarrio);
                Controller_colegio objcc = new Controller_colegio();
                boolean E = objcc.insertColegio(objc);
                if (E) {
                ...
                Colegio objc = new Colegio(nomColegio, telefono, correo, dirColegio, comuna, codigoBarrio, nomBarrio);
                Controller_colegio objcc = new Controller_colegio();
                boolean E = objcc.insertColegio(objc);
                if (E) {
                    JOptionPane.showMessageDialog(null, "Se inserto con exito");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Interfaz_colegio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Interfaz_colegio().setVisible(true);
            }
        });
    }
